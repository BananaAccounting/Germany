...
var Main = class Main {
  ...
  mainExecutionEBilanz54KapG(inData, options, dataCompany, dataLevelCompany) {
  ...
  mainExecutionEBilanzEBilanz54EinzelU(inData, options, dataCompany, dataLevelCompany) {
  ...
  mainExecutionEBilanz67KapG(inData, options, dataCompany, dataLevelCompany) {
    ...
    accountingData.getAccountingDataEBilanz67KapG(param, contextList);
